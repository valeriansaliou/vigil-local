...
[![Test and Build](https://github.com/valeriansaliou/vigil-local/actions/workflows/test.yml/badge.svg)](https://github.com/valeriansaliou/vigil-local/actions/workflows/test.yml) [![Build and Release](https://github.com/valeriansaliou/vigil-local/actions/workflows/build.yml/badge.svg)](https://github.com/valeriansaliou/vigil-local/actions/workflows/build.yml) [![dependency status](https://deps.rs/repo/github/valeriansaliou/vigil-local/status.svg)](https://deps.rs/repo/github/valeriansaliou/vigil-local) [![Buy Me A Coffee](https://img.shields.io/badge/buy%20me%20a%20coffee-donate-yellow.svg)](https://www.buymeacoffee.com/valeriansaliou)
...
```bash
docker pull valeriansaliou/vigil-local:v1.2.6
```
...
```bash
docker run -v /path/to/your/vigil-local/config.cfg:/etc/vigil-local.cfg valeriansaliou/vigil-local:v1.2.6
```
...
* `report_prefix` (type: _string_, allowed: any string, default: no default) — Prefix to prepend to the `replica` identifier reported to Vigil (useful if you run multiple Vigil Local instances on different servers, all reporting to the same aggregated Vigil node)
